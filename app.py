...
if _active == "scanner":
    ...
    with st.sidebar.expander("🧪 סינוני איכות מתקדמים", expanded=False):
        ...
        require_stage2 = st.checkbox(
            "דרוש Stage 2 מלא (Weinstein/Minervini)", value=True,
            help="הסינון המשמעותי ביותר לאיכות: מחייב Close > SMA150 > SMA200 עולה. "
                 "בלעדיו יעברו גם מניות במגמת-על חלשה שרק 'נראות' קדם-פריצה טכנית."
        )
        rsi_range = st.slider(
            "טווח RSI:", 0, 100, (45, 65),
            help="ברירת מחדל 45-65: מונע גם overbought (כבר 'רץ') וגם oversold (חולשה אמיתית, לא כיווץ)."
        )
