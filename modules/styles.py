...
def render_css():
    ...
    <style>
        ...
        /* בועת הערך שמופיעה מעל הידית - נשארים קרוב לברירת המחדל של Streamlit
           (בלי הגדלת פונט) כי זה מה שגרם לחפיפה/הדבקה בין שני ערכים בסליידר
           טווח (כמו "65" ו-"95" שהתלכדו ל-"6595"). מוסיפים רק צבע + רקע קטן
           עם white-space:nowrap כדי להבטיח שכל בועה נשארת מופרדת וקריאה. */
